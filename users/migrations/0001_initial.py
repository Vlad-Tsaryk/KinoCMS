    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Male')], max_length=10)),
                ('language', models.CharField(choices=[('Ukranian', 'Українська'), ('Russian', 'Русский')], max_length=10)),
